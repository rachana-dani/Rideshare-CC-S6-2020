...
ride_port = "80"
container="users"
ride_ip = "52.23.180.251"
ip_address_load="rideshare-790176747.us-east-1.elb.amazonaws.com"
...
class ridesList(APIView):
    ...
    def post(self,request):
        ...
        users_list = requests.get("http://"+ip_address_load+":"+user_port+"/api/v1/users",headers={"Origin":ride_ip})
